      ...
      renderBody: (value: TransactionDetail) => (
        <div>
          ...
          >
            {value.from ? (
              <a
                href={`${BSC_SCAN_URL}/address/` + value.from}
                onClick={() =>
                  window.open(`${BSC_SCAN_URL}/address/` + value.from, "_blank")
                }
              >
      ...
      renderBody: (value: TransactionDetail) => (
        <div>
          ...
          >
            {value.to ? (
              <a
                href={`${BSC_SCAN_URL}/address/` + value.to}
                onClick={() =>
                  window.open(`${BSC_SCAN_URL}/address/` + value.to, "_blank")
                }
              >
                {value.to.slice(0, 5)} ...{" "}
      ...
      renderBody: (value: TransactionDetail) => (
        <div>
          ...
          >
            {value.txhash ? (
              <a
                href={`${BSC_SCAN_URL}/tx/` + value.txhash}
                onClick={() =>
                  window.open(`${BSC_SCAN_URL}/tx/` + value.txhash, "_blank")
                }
              >
                {value.txhash}
              </a>
