      ...
      <div className="mt-3">
        ...
        <div className="h-70-custom pl-8 pr-8 flex card-fee-item-body">
          ...
          <div className="flex items-center h-full card-donation-fee custom-disable-input-fee">
            <InputDefault type="number" disabled={!updateFee} min={minFee} max={maxFee} step={1} value={valueInputFee} onChange={handleChangeInput("keyword")}/>
            <div className="flex justify-end">
              {updateFee ? (<React.Fragment>
                  <img src={IconSaveFee} alt="icon" className="cursor-pointer mr-2" onClick={updateDonationFee}/>
                  <img src={IconCancelFee} onClick={handleOpenFormEditFee("keyword", false)} alt="icon" className="cursor-pointer"/>
                </React.Fragment>) : (<img src={IconEditFee} onClick={handleOpenFormEditFee("keyword", true)} alt="icon" className="cursor-pointer"/>)}
            </div>
          </div>
        </div>
      </div>
