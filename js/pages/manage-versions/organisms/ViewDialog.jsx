...
const ViewDialog = (props) => {
    ...
    return (<DialogCard openPopup={openPopup} disablePopup handleCLoseDialog={onClose} title={`Version ${version} - ${format(new Date(publishedDate), "dd MMM yyyy")}`} rootStyle={{
            width: "40vw",
        }}>
      <div style={{
            maxHeight: "75vh",
