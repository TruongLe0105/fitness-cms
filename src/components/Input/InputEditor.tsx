...
interface Props {
  value: any;
  setValue: (value: any, newEditorStateFormatHtml?: any) => void;
  optionsInput?: string[];
...
const InputEditor = (props: Props): JSX.Element => {
  const {
    setValue,
    value,
    optionsInput,
  ...
  const debounceSearch = useCallback(
    debounce((newSearch: EditorState) => {
  ...
  return (
    <div
      className="card-input-editor pl-6 pr-0.5 pt-1 pb-74-custom root-draft-editor custom-toolbar-editor relative"
    ...
    >
      ...
      <Editor
        ...
        toolbarHidden={optionsInput?.length === 0}
        editorState={editorState}
        toolbarClassName="input-editor-toolbar"
        editorClassName="input-editor-class height-editor"
