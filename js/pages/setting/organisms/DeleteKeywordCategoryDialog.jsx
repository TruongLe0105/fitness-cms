...
const DeleteKeywordCategoryDialog = (props) => {
    const { openPopup, onClose, onSubmit } = props;
    const isLoading = useBoolean();
    return (<DialogCard openPopup={openPopup} disablePopup handleCLoseDialog={onClose} title="Delete keyword category" childrenAction={<img src={IconDestroy} alt="icon" className="cursor-pointer ml-3"/>}>
      <div className="flex items-center justify-center border rounded-lg border-red-custom mb-8 mt-4 p-3" style={{ padding: 20 }}>
