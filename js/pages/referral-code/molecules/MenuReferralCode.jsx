...
const MenuReferralCode = (props) => {
    const { active, handleChangeMenu } = props;
    return (<div className="flex items-center">
      {LIST_MENU.map((el, index) => (<div key={index} className="h-30-custom flex flex-col justify-between items-center mr-8 cursor-pointer" onClick={handleChangeMenu(index, el.field)}>
...
export default MenuReferralCode;
