import { startOfWeek, endOfWeek, startOfMonth, endOfMonth, startOfYear, endOfYear, startOfQuarter, endOfQuarter, isSameDay, } from "date-fns";
...
export var FILED_DATE_RANGES;
(function (FILED_DATE_RANGES) {
    FILED_DATE_RANGES["WEEK"] = "week";
    FILED_DATE_RANGES["MONTH"] = "month";
    FILED_DATE_RANGES["QUARTER"] = "quarter";
    FILED_DATE_RANGES["YEAR"] = "year";
    FILED_DATE_RANGES["CUSTOM"] = "custom";
})(FILED_DATE_RANGES || (FILED_DATE_RANGES = {}));
// eslint-disable-next-line
...
export const listSelectDateRanges = [
    {
        label: "This Week",
        filed: FILED_DATE_RANGES.WEEK,
        startDate: definedDateRanges.startOfWeek,
