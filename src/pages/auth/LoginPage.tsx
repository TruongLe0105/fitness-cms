...
const LoginPage = (): JSX.Element => {
  ...
  const onSubmitLogin = () => {
    ...
    loginMiddleware(
      dataRequest,
      (status: STATUS_RESPONSE_CODE, message: string, token: string) => {
  ...
  return (
    <PageLayoutAuth title="Login" subtitle="Please login to start using!">
      <InputDefault
        label="Username"
        rootClass="mb-6"
      ...
      <ButtonDefault
        ...
        buttonClass="absolute bottom-10 left-32"
      >
        Login
      </ButtonDefault>
