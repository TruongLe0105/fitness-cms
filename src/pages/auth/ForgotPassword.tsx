...
const ForgotPassword = (): JSX.Element => {
  ...
  const onSubmitForgotPassword = () => {
    const dataRequest: ForgotPasswordRequest = {
      email: email.value,
    };
    isLoadingSubmit.setValue(true);
    forgotPasswordMiddleware(dataRequest, (status: STATUS_RESPONSE_CODE) => {
  ...
  return (
    <PageLayoutAuth
      title={isSendMail.value ? "Please confirm your email" : "Forgot Password"}
      subtitle={
        isSendMail.value ? "" : "Please enter your email to reset the password!"
      }
    >
      {isSendMail.value ? (
        <React.Fragment>
