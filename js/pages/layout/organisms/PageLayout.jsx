...
const PageLayout = (props) => {
    ...
    const openMenu = useBoolean(menuLocal && menuLocal === "false" ? false : true);
    const handleChangeMenu = () => {
        openMenu.setValue(!openMenu.value);
        localStorage.setItem("menu_local", String(!openMenu.value));
    };
    return (<div className="w-full h-screen py-8 pl-8">
      <div className="flex h-full" style={{
        ...
        <div style={{
          ...
          <MenuLayout handleChangeMenu={handleChangeMenu} openMenu={openMenu.value}/>
        </div>
