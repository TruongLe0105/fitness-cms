...
const DialogWarning = ({ onSubmit, handleCLoseDialog, children, ...restProps }) => {
    return (<DialogCard handleCLoseDialog={handleCLoseDialog} {...restProps}>
      ...
      <div className="flex gap-5 justify-end">
        <ButtonDefault style={{ background: "#eb5757", fontWeight: "bold" }} widthButton="w-140-custom" onClick={() => onSubmit()}>
          Yes, delete it
        </ButtonDefault>
      </div>
    </DialogCard>);
