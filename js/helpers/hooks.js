...
// eslint-disable-next-line
export function useDefault(defaultValue) {
    const [value, setValue] = useState(defaultValue);
    return { value, setValue };
}
// eslint-disable-next-line
export const useTable = (defaultOrderBy = "created_at", defaultOrderDirection = ORDER_DIRECTION.DESC, defaultLimit = 10, defaultPage = 1) => {
    ...
    const handleChangeSort = (newOrderby, newOrderDirection) => () => {
...
// eslint-disable-next-line
export const useFilter = (page, isLoadingTable, setFilterCategory) => {
    ...
    const handleChangeCheckedFilter = (filedTitle, filedChecked) => () => {
    ...
    const handleRemoveFilter = (filedTitle) => () => {
...
export const useSelectDateRanges = () => {
    ...
    const [activeSelect, setActiveSelect] = useState(FILED_DATE_RANGES.WEEK);
