...
import { LIST_MENU_LEGAL } from "../types";
const MenuLegal = (props) => {
    const { active, handleChangeMenu } = props;
    return (<div className="flex items-center">
      {LIST_MENU_LEGAL.map((el, index) => (<div key={index} className="h-30-custom flex flex-col justify-between items-center mr-8 cursor-pointer" onClick={handleChangeMenu(index, el.field)}>
