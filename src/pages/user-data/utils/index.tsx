    ...
    },
    {
      ...
      renderBody: (value: UserDetail) => (
        <div>
          ...
          >
            <a
              href={`${BSC_SCAN_URL}/address/` + value.wallet}
              target="_blank"
              onClick={() =>
                window.open(`${BSC_SCAN_URL}/address/` + value.wallet, "_blank")
              }
            >
              {value.wallet && value.wallet.length
                ? `${value.wallet.slice(0, 10)}...${value.wallet.slice(
                    value.wallet.length - 10,
                    value.wallet.length
                  )}`
                : ""}
            </a>
