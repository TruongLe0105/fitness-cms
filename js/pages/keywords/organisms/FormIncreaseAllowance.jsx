...
const FormIncreaseAllowance = (props) => {
    ...
    const onSubmitButton = async () => {
        ...
        await increaseAllowance(KEYWORD_CONTRACT_ADDRESS, dataItem.allowanceValue, account, (status) => {
    ...
    return (<DialogCard openPopup={openForm} disablePopup handleCLoseDialog={onClose} title="Increase Allowance">
