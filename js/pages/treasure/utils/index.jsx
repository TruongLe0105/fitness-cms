...
import { FiledFilterItem, TOKEN_STATUS_FILTER, TYPES_STATUS_FILTER, } from '../types';
const DATA_CONTRACT = {
    ...
    const headers = [
        {
            ...
            renderBody: (value) => (<div className='flex justify-center cursor-pointer'>
          <div style={{
        ...
        },
        {
            ...
            renderBody: (value) => (<div className='flex flex-col cursor-pointer'>
        ...
        },
        {
            ...
            renderBody: (value) => (<p className=''>{value.description}</p>),
        },
        {
            title: 'Image',
            field: 'image',
        ...
        },
        {
            ...
            renderBody: (value) => (<p style={{ color: '#c93e3e' }}>{value.isClaimed ? 'Claimed' : ''}</p>),
        },
        {
            title: 'Total',
            field: 'total',
            ...
            sort: true,
            renderBody: (value) => (<p>{`${value.total} ${DATA_CONTRACT[value?.tokenContract]}`}</p>),
        },
        // {
        //   title: 'Action',
        //   field: 'action',
