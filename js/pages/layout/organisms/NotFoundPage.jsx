...
const NotFoundPage = () => {
    ...
    return (<div className="w-full h-screen flex flex-col items-center justify-center">
      ...
      <Typography variant="h6" textColor="text-black" fontWeight="font-normal" textClass="pt-6">
        Oops, Looks like something was wrong
      </Typography>
      <Typography variant="h6" textColor="text-black" fontWeight="font-normal" textClass="pt-2">
        We’re working on IT
      </Typography>
