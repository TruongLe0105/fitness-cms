...
import {
  AdvertisementDetail,
  defaultAddAdvertisementInput,
  FormAddNewAdvertisementProps,
} from '../types';
import '../styles/index.css';
...
const VIDEO_DEFAULT =
  'https://dataweb.hocthemtienganh.com/school/022021/1612865332_default-video-thumbnail.jpg';

export const FormCreateAdvertisement: FC<FormAddNewAdvertisementProps> = ({
  openForm,
  onClose,
  onRefetch,
}) => {
  const [advertisementDetail, setAdvertisementDetail] =
    useState<AdvertisementDetail>(defaultEmptyAdvertisementDetail);
  const isLoading = useBoolean();
  const keyInputFile = useString();
  const [urlVideo, setUrlVideo] = useState<any>(null);
      ...
      <div className='flex flex-col flex-1'>
        <div className='grid grid-cols-2 gap-5'>
          <InputDefault
            label='Name video'
            required
            value={advertisementDetail.name}
        ...
        <div className='flex flex-1 mt-auto'>
          <ButtonDefault
            ...
            disabled={!urlVideo || !advertisementDetail.name}
            style={{
              minHeight: 37,
              marginTop: 'auto',
            }}
