...
import { SelectNewTreasure } from '../types';
import InputDefault from 'components/Input/InputDefault';
import { ParamsStarRequest, StarDetail } from 'pages/stars/types';
...
const FormSelectNewTreasure: FC<SelectNewTreasure> = ({
  openForm,
  onClose,
  starId,
  handleChange,
  ...
  const getArrayStarId = async (source?: CancelTokenSource) => {
  ...
  return (
    ...
    >
      <div
        style={{ width: '240px', position: 'relative', marginBottom: '22px' }}
      >
        <InputDefault
          value={search.value}
            ...
            <div
              ...
              style={
                checkStarId()
                  ...
                  : {
                      background:
                        item.id === starId ? '#8080807a' : 'transparent',
                    }
              }
              onClick={() => {
                if (!checkStarId()) {
