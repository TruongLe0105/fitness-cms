...
import { FormDialogProps, FormInput } from "../interfaces";
import {
  createVersionMiddleware,
  updateVersionMiddleware,
} from "../services/api";
  ...
  return (
    ...
    >
      <InputDefault
        ...
        onChange={handleChangeInput("version")}
      ...
      >
        <InputDefault
          ...
          label="Android Link"
          rootClass="mb-6"
          value={formInput.androidLink}
          onChange={handleChangeInput("androidLink")}
          onKeyPress={onKeyPress}
          rootStyle={{ width: "45%" }}
        />
        <InputDefault
          ...
          label="IOS Link"
          rootClass="mb-6"
          value={formInput.iosLink}
          onChange={handleChangeInput("iosLink")}
          onKeyPress={onKeyPress}
          rootStyle={{ width: "45%" }}
        />
      </div>
      <div className="flex text-center justify-between">
        ...
        >
          <input
            ...
            name="vehicle1"
            value="Bike"
            checked={isShowPreview.value}
            onChange={() => isShowPreview.setValue(!isShowPreview.value)}
            style={{ marginRight: 5, width: 16, height: 16 }}
          ></input>
          <label
            htmlFor="vehicle1"
            className="text-sm font-semibold text-gray-custom text-x"
          >
            Show preview
          </label>
        </div>
