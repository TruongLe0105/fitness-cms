...
const AvatarUserHeader = () => {
    ...
    return (<Popup trigger={<div className="flex items-center cursor-pointer">
      ...
      <div className="logout-card mt-3">
        <div className="h-8 pl-3.5 pr-3.5 flex items-center justify-between bg-primary-custom cursor-pointer relative content-menu-logout" onClick={handleLogout}>
          <Typography textColor="text-primary-custom" fontWeight="font-medium" textClass="text-xs">
            Log out
          </Typography>
