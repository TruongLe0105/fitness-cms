...
import { emptyNotificationDetail, emptyUserCharacterDetail, emptyUserDetail, ListOptionToSendSelect, ListSentSelect, TYPE_NOTIFICATION, ListPointSelect, } from "./types";
...
const userPage = () => {
    ...
    const [pointSelect, setPointSelect] = useState(ListPointSelect[0]);
    ...
    const [formDataInventory, setFormDataUser] = useState(emptyUserDetail);
    ...
    const handleChangePointSelect = (value) => {
    ...
    //   setFormDataUser(emptyUserDetail);
    // };
    return (<PageLayout title="User" childrenAction={<div className="flex items-center justify-between h-full pr-8">
    ...
    data={user.length ? user : []} handleChangeSort={handleChangeSort} orderBy={orderBy.value} orderDirection={orderDirection.value} isLoadingTable={isLoadingTable.value}/>
