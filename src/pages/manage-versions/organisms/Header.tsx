...
export const renderHeader = (
  onView: (item: ManageVersion) => void,
  onEdit: (item: ManageVersion) => void,
  onDelete: (item: ManageVersion) => void
): Header[] => [
  {
    title: "No",
    field: "stt",
  ...
  },
  {
    ...
    renderBody: (value: ManageVersion) => (
      <p>{format(new Date(value.publishedDate), "dd MMM yyyy")}</p>
    ),
  },
  {
    title: "Android Link",
