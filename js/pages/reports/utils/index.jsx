...
export function dataHeaderReport(sumListingFee, sumDonationFee) {
    const headers = [
        {
            title: "No",
            field: "no",
            ...
            renderBody: (value, index) => (<p>{Number(index) + 1}</p>),
        },
        {
            title: "From",
            field: "from",
            ...
            sort: true,
            renderBody: (value) => (<AddressCard address={value.from} owner={value.seller}/>),
        },
        {
            title: "To",
            field: "to",
            ...
            sort: true,
            renderBody: (value) => (<AddressCard address={value.to} owner={value.buyer}/>),
        },
        {
            title: "Action",
            field: "action",
        ...
        },
        {
            ...
            renderBody: (value) => (<StarAndKeyword keyword={value.keyword} star={value.star}/>),
        },
        {
            title: "Listing Fee",
            field: "listingFee",
            ...
            renderHeader: (<div className="flex flex-col justify-center items-center">
