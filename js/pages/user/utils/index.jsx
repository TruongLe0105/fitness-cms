...
handleOpenUpdateList) {
    const headers = [
        ...
        },
        {
          ...
          <p 
            ...
            <a href={`${BSC_SCAN_URL}/address/` + value.walletAddress}>
              ...
              {value.walletAddress &&
                    value.walletAddress.slice(value.walletAddress.length - 10, value.walletAddress.length)}
            </a>
        ...
        },
        {
            ...
            sort: true,
            renderBody: (value) => (<p className="uppercase">{value.tokenCount}</p>),
        },
        // {
        ...
        },
        {
            ...
            sort: true,
            renderBody: (value) => (<p>{value.updatedAt ? formatDate(value.updatedAt) : ""}</p>),
        },
        {
            title: "Action",
            field: "action",
          ...
          <div className="ml-2">
            <DefaultButtonIcon disable={!value.id ? true : false} onClick={handleOpenUpdateList("edit", value)} field="edit" titleTooltip="Update" keyButtonIcon={Math.random().toString(36)}/>
          </div>
          <div className="ml-2">
            <DefaultButtonIcon disable={!value.id ? true : false} onClick={handleOpenUpdateList("delete", value)} field="delete" titleTooltip="Destroy" keyButtonIcon={Math.random().toString(36)}/>
          </div>
        </div>),
        },
    ];
