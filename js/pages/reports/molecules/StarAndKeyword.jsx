...
const StarAndKeyword = (props) => {
    const { keyword, star } = props;
    const renderBody = () => {
        if (star) {
            return (<div className="flex items-center">
          <div style={{
                    backgroundImage: `url(${star.imgUrlPreview
                        ? star.imgUrlPreview
          ...
          <div className="flex flex-col ml-2">
            ...
            {keyword ? (<p className="text-xs font-normal text-gray-06-custom italic">
        ...
        if (keyword) {
            return (<p className="text-sm font-normal text-gray-06-custom">
          {`Keyword: ${keyword.name}`}
        </p>);
        }
        return <div />;
