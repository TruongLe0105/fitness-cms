...
export const STAR_CONTRACT_ADDRESS =
  process.env.REACT_APP_STAR_CONTRACT_ADDRESS || "";

export const KEYWORD_CONTRACT_ADDRESS =
  process.env.REACT_APP_KEYWORD_CONTRACT_ADDRESS || "";
