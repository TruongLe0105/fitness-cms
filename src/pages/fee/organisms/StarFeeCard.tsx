        ...
        <div className="h-70-custom pl-8 pr-8 flex card-fee-item-body">
          ...
          <div className="flex items-center h-full">
            <Typography
              ...
              onClick={onRedirectTestnet(feeDetail.donationWaller)}
            >
          ...
          <div className="flex items-center h-full card-donation-fee custom-disable-input-fee">
            <InputDefault
              ...
              step={1}
              value={valueInputFee}
              onChange={handleChangeInput("star")}
            />
              ...
              {updateFee ? (
                <React.Fragment>
                  <img
                    ...
                    onClick={updateDonationFee}
                  />
                  <img
                    src={IconCancelFee}
                    onClick={handleOpenFormEditFee("star", false)}
                    alt="icon"
                ...
                <img
                  src={IconEditFee}
                  onClick={handleOpenFormEditFee("star", true)}
                  alt="icon"
                  className="cursor-pointer"
                />
              )}
