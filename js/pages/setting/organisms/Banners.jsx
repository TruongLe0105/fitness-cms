    ...
    return (<div className="flex flex-col">
      <div className="flex gap-20">
        <div>
          ...
          <SetBanner setLoading={loading.setValue} visibleBannerNote={true} width={343} height={114} inputId="benefit_pioneer" message="banner Pioneer Benefit" bannerName={Banner.BENEFIT_PIONEER}/>
        </div>
        <div>
          <Typography variant="h6" textColor="text-black" fontWeight="font-semibold">
            Ads
          </Typography>
          <SetBanner setLoading={loading.setValue} visibleBannerNote={true} width={279} height={64} inputId="ads_banner" message="Ads Banner" bannerName={Banner.ADS} accept=".gif"/>
        </div>
      </div>
      {/* <div className="mt-3">
          <Typography
