...
const ResetPassword = () => {
    ...
    const onSubmitResetPassword = () => {
        ...
        resetPasswordMiddleware(tokenParam.replace("/", ""), dataRequest, (status) => {
    ...
    return (<PageLayoutAuth title="Reset password" subtitle={isVerifyPassword.value
            ? "You have changed password successfully!"
            : "Please enter your new password!"}>
      {isVerifyPassword.value ? (<React.Fragment>
          ...
          <InputDefault label="Password" rootClass="mb-6" value={password.value} type={changeTypePasswordInput.value ? "text" : "password"} childrenIcon={<IconInputPassword isShowPassword={changeTypePasswordInput.value} handleChangeIconPassword={handleChangeIconPassword}/>} onChange={handleChangePassword} onKeyPress={onKeyPress}/>
          <InputDefault label="Confirm password" rootClass="mb-6" value={confirmPassword.value} type={changeTypePasswordInput.value ? "text" : "password"} childrenIcon={<IconInputPassword isShowPassword={changeTypePasswordInput.value} handleChangeIconPassword={handleChangeIconPassword}/>} onChange={handleChangeConfirmPassword} onKeyPress={onKeyPress}/>
          ...
          <ButtonDefault disabled={isDisabledButton()} widthButton="w-140-custom" onClick={onSubmitResetPassword}>
            Change My Password
          </ButtonDefault>
        </React.Fragment>)}
