...
const ViewDetail = (props) => {
    ...
    return (<DialogCard openPopup={openPopup} handleCLoseDialog={onClose} disablePopup title="View detail notification" rootStyle={{
            width: 600,
            paddingRight: 0,
      ...
      <div className="flex flex-col overflow-auto max-height-view-notification">
        ...
        {dataItem.startDate ? (<TypographyItemCard title="Schedule-Timeline" label={formatDate(dataItem.startDate, "dd MMM yyyy, HH:mm:ss a")}/>) : null}
      </div>
    </DialogCard>);
};
