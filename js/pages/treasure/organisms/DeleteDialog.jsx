...
import { deleteTreasure } from '../services/api';
const DestroyDialog = (props) => {
    ...
    return (<DialogCard openPopup={openPopup} disablePopup handleCLoseDialog={onClose} title='Delete star' childrenAction={<img src={IconDestroy} alt='icon' className='cursor-pointer ml-3'/>}>
